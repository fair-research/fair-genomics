...
The FAIR Research data portal is available at: https://globus-portal.fair-research.org/4M.4.Fullstacks/ and users can login using the Login link in the top-right corner. 
...
#### Search
The downsampled CRAM files have an annotation of "downsampled" within the data portal. Use the search term "downsampled" in the search box at: https://globus-portal.fair-research.org/4M.4.Fullstacks/search/ 
...
Click on the "Create Workspace" button to add the 5 samples to a "Workspace" collection called "Downsampled Topmed" as shown below. 

#### Submit
From within the Workspaces (https://globus-portal.fair-research.org/4M.4.Fullstacks/workspaces/), click on each "Start" button to initiate a submission to the WES service. 
